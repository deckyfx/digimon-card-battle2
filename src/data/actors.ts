...
export const ACTORS: Actor[] = [
  ...
  { id: 2, name: "Betamon", portrait: "/assets/potraits/02.png", deckIds: [1,137,138], exp: 2, prizePack: "basic", isPlayer: false },
  { id: 3, name: "Agumon", portrait: "/assets/potraits/03.png", deckIds: [2], exp: 3, prizePack: "basic", isPlayer: false },
  { id: 4, name: "Penguinmon", portrait: "/assets/potraits/04.png", deckIds: [3], exp: 4, prizePack: "basic", isPlayer: false },
  { id: 5, name: "Babamon", portrait: "/assets/potraits/05.png", deckIds: [4], exp: 5, prizePack: "hyper", isPlayer: false },
  { id: 6, name: "Meramon", portrait: "/assets/potraits/06.png", deckIds: [5], exp: 4, prizePack: "basic", isPlayer: false },
  { id: 7, name: "Phoenixmon", portrait: "/assets/potraits/07.png", deckIds: [6], exp: 4, prizePack: "basic", isPlayer: false },
  { id: 8, name: "Veemon", portrait: "/assets/potraits/08.png", deckIds: [7,121], exp: 5, prizePack: "red", isPlayer: false },
  { id: 9, name: "Vegiemon", portrait: "/assets/potraits/09.png", deckIds: [8], exp: 5, prizePack: "green", isPlayer: false },
  { id: 10, name: "Ninjamon", portrait: "/assets/potraits/10.png", deckIds: [9], exp: 5, prizePack: "green", isPlayer: false },
  { id: 11, name: "Veedramon", portrait: "/assets/potraits/11.png", deckIds: [10], exp: 6, prizePack: "green", isPlayer: false },
  { id: 12, name: "Wormmon", portrait: "/assets/potraits/12.png", deckIds: [11,20], exp: 5, prizePack: "black", isPlayer: false },
  { id: 13, name: "Frigimon", portrait: "/assets/potraits/13.png", deckIds: [12], exp: 5, prizePack: "blue", isPlayer: false },
  { id: 14, name: "Whamon", portrait: "/assets/potraits/14.png", deckIds: [13], exp: 5, prizePack: "blue", isPlayer: false },
  { id: 15, name: "Garurumon", portrait: "/assets/potraits/15.png", deckIds: [14], exp: 6, prizePack: "blue", isPlayer: false },
  { id: 16, name: "Stingmon", portrait: "/assets/potraits/16.png", deckIds: [15,21], exp: 6, prizePack: "black", isPlayer: false },
  { id: 17, name: "Hagurumon", portrait: "/assets/potraits/17.png", deckIds: [16], exp: 5, prizePack: "yellow", isPlayer: false },
  { id: 18, name: "ShellNumemon", portrait: "/assets/potraits/18.png", deckIds: [17], exp: 5, prizePack: "yellow", isPlayer: false },
  { id: 19, name: "KingSukamon", portrait: "/assets/potraits/19.png", deckIds: [18], exp: 6, prizePack: "yellow", isPlayer: false },
  { id: 20, name: "Shadramon", portrait: "/assets/potraits/20.png", deckIds: [19,22], exp: 7, prizePack: "black", isPlayer: false },
  { id: 21, name: "Quetzalmon", portrait: "/assets/potraits/21.png", deckIds: [23], exp: 8, prizePack: "black", isPlayer: false },
  { id: 22, name: "Digimon Emperor", portrait: "/assets/potraits/22.png", deckIds: [24], exp: 15, prizePack: "s-black", isPlayer: false },
  { id: 23, name: "Centarumon", portrait: "/assets/potraits/23.png", deckIds: [25], exp: 5, prizePack: "red", isPlayer: false },
  { id: 24, name: "Tyrannomon", portrait: "/assets/potraits/24.png", deckIds: [26], exp: 6, prizePack: "red", isPlayer: false },
  { id: 25, name: "Angemon", portrait: "/assets/potraits/25.png", deckIds: [27], exp: 7, prizePack: "green", isPlayer: false },
  ...
  { id: 30, name: "Wizardmon", portrait: "/assets/potraits/30.png", deckIds: [32], exp: 6, prizePack: "black", isPlayer: false },
  { id: 31, name: "AeroVeedramon", portrait: "/assets/potraits/31.png", deckIds: [33], exp: 7, prizePack: "green", isPlayer: false },
  { id: 32, name: "Gatomon", portrait: "/assets/potraits/32.png", deckIds: [34], exp: 8, prizePack: "green", isPlayer: false },
  { id: 33, name: "Kari", portrait: "/assets/potraits/33.png", deckIds: [35,133,134], exp: 8, prizePack: "green", isPlayer: false },
  { id: 34, name: "Goburimon", portrait: "/assets/potraits/34.png", deckIds: [36], exp: 5, prizePack: "option", isPlayer: false },
  { id: 35, name: "DemiDevimon", portrait: "/assets/potraits/35.png", deckIds: [37], exp: 6, prizePack: "black", isPlayer: false },
  { id: 36, name: "Megadramon", portrait: "/assets/potraits/36.png", deckIds: [38], exp: 7, prizePack: "black", isPlayer: false },
  { id: 37, name: "Gigadramon", portrait: "/assets/potraits/37.png", deckIds: [39], exp: 8, prizePack: "super", isPlayer: false },
  { id: 38, name: "Togemon", portrait: "/assets/potraits/38.png", deckIds: [40], exp: 8, prizePack: "green", isPlayer: false },
  { id: 39, name: "Kabuterimon", portrait: "/assets/potraits/39.png", deckIds: [41], exp: 8, prizePack: "green", isPlayer: false },
  { id: 40, name: "Ikkakumon", portrait: "/assets/potraits/40.png", deckIds: [42], exp: 8, prizePack: "blue", isPlayer: false },
  { id: 41, name: "Birdramon", portrait: "/assets/potraits/41.png", deckIds: [43], exp: 8, prizePack: "red", isPlayer: false },
  { id: 42, name: "WereGarurumon", portrait: "/assets/potraits/42.png", deckIds: [44], exp: 8, prizePack: "blue", isPlayer: false },
  { id: 43, name: "MetalGreymon", portrait: "/assets/potraits/43.png", deckIds: [45], exp: 8, prizePack: "super", isPlayer: false },
  { id: 44, name: "Tuskmon", portrait: "/assets/potraits/44.png", deckIds: [46], exp: 8, prizePack: "black", isPlayer: false },
  { id: 45, name: "Phantomon", portrait: "/assets/potraits/45.png", deckIds: [47], exp: 8, prizePack: "black", isPlayer: false },
  { id: 46, name: "MegaSeadramon", portrait: "/assets/potraits/46.png", deckIds: [48], exp: 8, prizePack: "blue", isPlayer: false },
  { id: 47, name: "VenomMyotismon", portrait: "/assets/potraits/47.png", deckIds: [49], exp: 10, prizePack: "s-black", isPlayer: false },
  { id: 48, name: "Leomon", portrait: "/assets/potraits/48.png", deckIds: [50], exp: 8, prizePack: "green", isPlayer: false },
  { id: 49, name: "Devimon", portrait: "/assets/potraits/49.png", deckIds: [51], exp: 9, prizePack: "great", isPlayer: false },
  { id: 50, name: "MetalEtemon", portrait: "/assets/potraits/50.png", deckIds: [52], exp: 9, prizePack: "s-yellow", isPlayer: false },
  ...
  { id: 53, name: "ExVeemon", portrait: "/assets/potraits/53.png", deckIds: [55], exp: 8, prizePack: "red", isPlayer: false },
  { id: 54, name: "Flamedramon", portrait: "/assets/potraits/54.png", deckIds: [56], exp: 9, prizePack: "s-red", isPlayer: false },
  { id: 55, name: "Raidramon", portrait: "/assets/potraits/55.png", deckIds: [57], exp: 10, prizePack: "red", isPlayer: false },
  { id: 56, name: "Hawkmon", portrait: "/assets/potraits/56.png", deckIds: [58,122], exp: 8, prizePack: "green", isPlayer: false },
  { id: 57, name: "Aquilamon", portrait: "/assets/potraits/57.png", deckIds: [59], exp: 8, prizePack: "super", isPlayer: false },
  { id: 58, name: "Halsemon", portrait: "/assets/potraits/58.png", deckIds: [60], exp: 10, prizePack: "green", isPlayer: false },
  { id: 59, name: "Armadillomon", portrait: "/assets/potraits/59.png", deckIds: [61,123], exp: 8, prizePack: "yellow", isPlayer: false },
  { id: 60, name: "Ankylomon", portrait: "/assets/potraits/60.png", deckIds: [62], exp: 9, prizePack: "s-yellow", isPlayer: false },
  { id: 61, name: "Digmon", portrait: "/assets/potraits/61.png", deckIds: [63], exp: 10, prizePack: "yellow", isPlayer: false },
  { id: 62, name: "Thundermon", portrait: "/assets/potraits/62.png", deckIds: [64], exp: 8, prizePack: "yellow", isPlayer: false },
  { id: 63, name: "MetalMamemon", portrait: "/assets/potraits/63.png", deckIds: [65], exp: 9, prizePack: "s-yellow", isPlayer: false },
  { id: 64, name: "SuperStarmon", portrait: "/assets/potraits/64.png", deckIds: [66], exp: 10, prizePack: "s-yellow", isPlayer: false },
  { id: 65, name: "Bakemon", portrait: "/assets/potraits/65.png", deckIds: [67], exp: 8, prizePack: "black", isPlayer: false },
  { id: 66, name: "Devimon (Variant)", portrait: "/assets/potraits/66.png", deckIds: [68], exp: 9, prizePack: "s-black", isPlayer: false },
  { id: 67, name: "SkullGreymon", portrait: "/assets/potraits/67.png", deckIds: [69], exp: 10, prizePack: "s-black", isPlayer: false },
  { id: 68, name: "Myotismon (Variant)", portrait: "/assets/potraits/68.png", deckIds: [70], exp: 11, prizePack: "s-black", isPlayer: false },
  { id: 69, name: "Patamon", portrait: "/assets/potraits/69.png", deckIds: [71], exp: 8, prizePack: "option", isPlayer: false },
  { id: 70, name: "Baronmon", portrait: "/assets/potraits/70.png", deckIds: [72], exp: 9, prizePack: "great", isPlayer: false },
  { id: 71, name: "Pegasusmon", portrait: "/assets/potraits/71.png", deckIds: [73], exp: 10, prizePack: "green", isPlayer: false },
  { id: 72, name: "Gatomon (Variant)", portrait: "/assets/potraits/72.png", deckIds: [74], exp: 8, prizePack: "green", isPlayer: false },
  { id: 73, name: "Nefertimon", portrait: "/assets/potraits/73.png", deckIds: [75], exp: 9, prizePack: "s-green", isPlayer: false },
  { id: 74, name: "Tylomon", portrait: "/assets/potraits/74.png", deckIds: [76], exp: 10, prizePack: "green", isPlayer: false },
  { id: 75, name: "Kuwagamon", portrait: "/assets/potraits/75.png", deckIds: [77], exp: 10, prizePack: "s-green", isPlayer: false },
  ...
  { id: 80, name: "Shurimon", portrait: "/assets/potraits/80.png", deckIds: [84], exp: 10, prizePack: "great", isPlayer: false },
  ...
  { id: 96, name: "MetalSeadramon", portrait: "/assets/potraits/96.png", deckIds: [98], exp: 12, prizePack: "s-blue", isPlayer: false },
  { id: 97, name: "Puppetmon", portrait: "/assets/potraits/97.png", deckIds: [99], exp: 12, prizePack: "s-yellow", isPlayer: false },
  { id: 98, name: "Machinedramon", portrait: "/assets/potraits/98.png", deckIds: [100], exp: 9, prizePack: "great", isPlayer: false },
  { id: 99, name: "LadyDevimon", portrait: "/assets/potraits/99.png", deckIds: [101], exp: 12, prizePack: "s-black", isPlayer: false },
  ...
  { id: 114, name: "BK WarGreymon", portrait: "/assets/potraits/114.png", deckIds: [115], exp: 16, prizePack: "s-red", isPlayer: false },
  ...
  { id: 119, name: "A", portrait: "/assets/potraits/119.png", deckIds: [120], exp: 30, prizePack: "s-option", isPlayer: false },
];
