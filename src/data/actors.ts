...
export const ACTORS: Actor[] = [
  ...
  { id: 26, name: "Davis", portrait: "/assets/potraits/26.png", deckIds: [28,124,125,126], exp: 8, isPlayer: false },
  { id: 27, name: "Keely", portrait: "/assets/potraits/27.png", deckIds: [29,127,128], exp: 8, isPlayer: false },
  { id: 28, name: "Cody", portrait: "/assets/potraits/28.png", deckIds: [30,129,130], exp: 8, isPlayer: false },
  { id: 29, name: "T.K.", portrait: "/assets/potraits/29.png", deckIds: [31,131,132], exp: 7, isPlayer: false },
  ...
  { id: 33, name: "Kari", portrait: "/assets/potraits/33.png", deckIds: [35,133,134], exp: 8, isPlayer: false },
  ...
  { id: 47, name: "VenomMyotismon", portrait: "/assets/potraits/47.png", deckIds: [49], exp: 10, isPlayer: false },
  ...
  { id: 51, name: "Myotismon", portrait: "/assets/potraits/51.png", deckIds: [53], exp: 10, isPlayer: false },
  { id: 52, name: "Greymon", portrait: "/assets/potraits/52.png", deckIds: [54], exp: 8, isPlayer: false },
  ...
  { id: 55, name: "Raidramon", portrait: "/assets/potraits/55.png", deckIds: [57], exp: 10, isPlayer: false },
  ...
  { id: 58, name: "Halsemon", portrait: "/assets/potraits/58.png", deckIds: [60], exp: 10, isPlayer: false },
  ...
  { id: 61, name: "Digmon", portrait: "/assets/potraits/61.png", deckIds: [63], exp: 10, isPlayer: false },
  ...
  { id: 64, name: "SuperStarmon", portrait: "/assets/potraits/64.png", deckIds: [66], exp: 10, isPlayer: false },
  ...
  { id: 68, name: "Myotismon (Variant)", portrait: "/assets/potraits/68.png", deckIds: [70], exp: 11, isPlayer: false },
  ...
  { id: 71, name: "Pegasusmon", portrait: "/assets/potraits/71.png", deckIds: [73], exp: 10, isPlayer: false },
  ...
  { id: 74, name: "Tylomon", portrait: "/assets/potraits/74.png", deckIds: [76], exp: 10, isPlayer: false },
  { id: 75, name: "Kuwagamon", portrait: "/assets/potraits/75.png", deckIds: [77], exp: 10, isPlayer: false },
  { id: 76, name: "HerculesKabuterimon", portrait: "/assets/potraits/76.png", deckIds: [78], exp: 13, isPlayer: false },
  { id: 77, name: "WarGreymon", portrait: "/assets/potraits/77.png", deckIds: [79], exp: 10, isPlayer: false },
  { id: 78, name: "Tai", portrait: "/assets/potraits/78.png", deckIds: [80], exp: 10, isPlayer: false },
  { id: 79, name: "Paildramon", portrait: "/assets/potraits/79.png", deckIds: [81], exp: 10, isPlayer: false },
  { id: 80, name: "Shurimon", portrait: "/assets/potraits/80.png", deckIds: [84], exp: 10, isPlayer: false },
  { id: 81, name: "Submarimon", portrait: "/assets/potraits/81.png", deckIds: [87], exp: 10, isPlayer: false },
  { id: 82, name: "MagnaAngemon", portrait: "/assets/potraits/82.png", deckIds: [94], exp: 10, isPlayer: false },
  { id: 83, name: "Angewomon", portrait: "/assets/potraits/83.png", deckIds: [95], exp: 10, isPlayer: false },
  { id: 84, name: "GranKuwagamon", portrait: "/assets/potraits/84.png", deckIds: [96], exp: 10, isPlayer: false },
  { id: 85, name: "Ken", portrait: "/assets/potraits/85.png", deckIds: [97,135,136], exp: 10, isPlayer: false },
  { id: 86, name: "Garudamon", portrait: "/assets/potraits/86.png", deckIds: [82], exp: 10, isPlayer: false },
  { id: 87, name: "Sora", portrait: "/assets/potraits/87.png", deckIds: [83], exp: 10, isPlayer: false },
  { id: 88, name: "Lillymon", portrait: "/assets/potraits/88.png", deckIds: [85], exp: 10, isPlayer: false },
  { id: 89, name: "Mimi", portrait: "/assets/potraits/89.png", deckIds: [86], exp: 10, isPlayer: false },
  { id: 90, name: "MetalGarurumon", portrait: "/assets/potraits/90.png", deckIds: [88], exp: 10, isPlayer: false },
  { id: 91, name: "Matt", portrait: "/assets/potraits/91.png", deckIds: [89], exp: 10, isPlayer: false },
  { id: 92, name: "Zudomon", portrait: "/assets/potraits/92.png", deckIds: [90], exp: 10, isPlayer: false },
  { id: 93, name: "Joe", portrait: "/assets/potraits/93.png", deckIds: [91], exp: 10, isPlayer: false },
  { id: 94, name: "MegaKabuterimon", portrait: "/assets/potraits/94.png", deckIds: [92], exp: 10, isPlayer: false },
  { id: 95, name: "Izzy", portrait: "/assets/potraits/95.png", deckIds: [93], exp: 10, isPlayer: false },
  ...
  { id: 100, name: "Piedmon", portrait: "/assets/potraits/100.png", deckIds: [102], exp: 12, isPlayer: false },
  { id: 101, name: "Magnamon", portrait: "/assets/potraits/101.png", deckIds: [103], exp: 12, isPlayer: false },
  { id: 102, name: "Sylphymon", portrait: "/assets/potraits/102.png", deckIds: [104], exp: 12, isPlayer: false },
  { id: 103, name: "Shakkoumon", portrait: "/assets/potraits/103.png", deckIds: [105], exp: 12, isPlayer: false },
  { id: 104, name: "Seraphimon", portrait: "/assets/potraits/104.png", deckIds: [106], exp: 12, isPlayer: false },
  { id: 105, name: "Magnadramon", portrait: "/assets/potraits/105.png", deckIds: [107], exp: 12, isPlayer: false },
  { id: 106, name: "Infermon", portrait: "/assets/potraits/106.png", deckIds: [108], exp: 13, isPlayer: false },
  { id: 107, name: "Diaboromon", portrait: "/assets/potraits/107.png", deckIds: [109], exp: 14, isPlayer: false },
  { id: 108, name: "Imperialdramon", portrait: "/assets/potraits/108.png", deckIds: [110], exp: 15, isPlayer: false },
  { id: 109, name: "Valkyrimon", portrait: "/assets/potraits/109.png", deckIds: [111], exp: 15, isPlayer: false },
  { id: 110, name: "Omnimon", portrait: "/assets/potraits/110.png", deckIds: [113], exp: 15, isPlayer: false },
  { id: 111, name: "Vikemon", portrait: "/assets/potraits/111.png", deckIds: [112], exp: 15, isPlayer: false },
  { id: 112, name: "Apokarimon", portrait: "/assets/potraits/112.png", deckIds: [114], exp: 25, isPlayer: false },
  { id: 113, name: "Apokarimon (Variant)", portrait: "/assets/potraits/113.png", deckIds: [114], exp: 25, isPlayer: false },
  { id: 114, name: "BK WarGreymon", portrait: "/assets/potraits/114.png", deckIds: [115], exp: 16, isPlayer: false },
  { id: 115, name: "BK MetalGarurumon", portrait: "/assets/potraits/115.png", deckIds: [116], exp: 16, isPlayer: false },
  { id: 116, name: "Rosemon", portrait: "/assets/potraits/116.png", deckIds: [117], exp: 5, isPlayer: false },
  { id: 117, name: "Nanimon", portrait: "/assets/potraits/117.png", deckIds: [118], exp: 10, isPlayer: false },
  { id: 118, name: "Piximon", portrait: "/assets/potraits/118.png", deckIds: [119], exp: 12, isPlayer: false },
